...
#'
#' @examples
create_decision_logic<- function (my_basic_summary,
                                          my_basic_summary_10yr,
                                          my_basic_summary_5yr) {


  df_grid <- expand.grid(waterbody_segment = unique(my_basic_summary$waterbody_segment), pollutant_group = paramlevels$pollutant_group,  test_fraction = c("TOTAL", "DISSOLVED", NA))
