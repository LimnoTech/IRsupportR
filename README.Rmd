...
-   Final results as Excel spreadsheets to allow for merge cell formatting
    ...
    -   Class C
        ...
        -   results\_class_c\_merge_part3.xlsx

    -   Class D

        -   results\_class_d\_merge_part1.xlsx

        -   results\_class_d\_merge_part2.xlsx

-   Final results as combined Excel spreadsheets. Includes merge cell formatting. Combined manually
