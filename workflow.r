...
write.csv(ir_data, "output/curated_ir_data_draft_20230523.csv")
...
write.csv(criteria_results, "output/criteria_results_draft_20230523.csv")
...
write.csv(my_basic_summary, file = "output/basic_summary_20230523.csv", row.names = F)
...
# write.csv(my_basic_summary_10yr, file = "output/intermediate_results_d_draft_20230523.csv", row.names = F)
...
# write.csv(my_compiled_summaries, file = "output/my_compiled_summaries_20230523.csv", row.names = F)
